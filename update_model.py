...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default="7f94b6dd13004aaf8c000dd0585c8c9a",
    )
    parser.add_argument(
        "--env_path",
        # required=True,
        help="Path to the .env file",
        default=f"{base_path}/.env",
    )
    parser.add_argument(
        "--repo_url",
        # required=True,
        help="Repository URL for the API project that will use the updated model.",
        default="git@github.com:uts-strykers/braintumour-api.git",
    )
    parser.add_argument(
        "--development_branch",
        # required=True,
